...
# ANN experiment
# Train ANN models for the sea level drivers experiment.
# Save all models.
...
from Functions import get_config, ensembleANN
...
# --- Fitting parameters (same for every station) ---
...
for s, si in zip(stat, range(len(stat))):
	...
	# input parameters
	hyperparams = {dim['l']: hyper.loc[s, dim['l']], dim['u'] : hyper.loc[s, dim['u']], \
